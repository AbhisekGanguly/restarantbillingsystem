...
def Ref():
    ...
    if (name.get()==""):
        def_name="customer's name"
    else:
        def_name=str(name.get())
    ...
    CustomerName=str(def_name)	       #Name of Customer defined here.
